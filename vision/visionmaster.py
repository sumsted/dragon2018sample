...
class VisionMaster:
    """ used on rio to tell jetson what to look for and to read the location response """
    ...
    def locate(self, thing):
        """
        tell jetson what you want to look for, check visionconstants module for list of things
    ...
    def get_location(self):
        """
        read the location state, as long as you've told jetson to look for a valid thing, there should be a value
